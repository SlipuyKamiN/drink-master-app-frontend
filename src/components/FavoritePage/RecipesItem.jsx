...
import placeholder from "../../images/no-content-cocktail.png";
  ...
  return <>
    <li className={css.RecipesItem}>
      ...
      <div className={css.wraperCard}>
        <img className={css.RecipesItemImg} src={placeholder} alt="glass" />
        ...
        <div className={css.wraperBottom}>
          <a className={css.RecipesItemLink} href="https://github.com/Bad-Raider/goit-react-hw-08-phonebook/tree/main/src">See recipe</a>
          <button className={css.RecipesItemButton} type="button">button</button>
        </div>
      </div>
    </li>
  </>
